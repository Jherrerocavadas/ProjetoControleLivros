...
import { buscarEmprestimo, excluirEmprestimo } from "../../../utils/Emprestimo/emprestimoController";
import { ModalEmprestimo } from "../../../Components/Modais";


export function ExcluirEmprestimo({route}) {
    ...
    if(modalVisible){
      return (
        ...
        nome={nome}
        telefone={telefone}
        labelActionBtn="Excluir Emprestimo"
        action={() => {excluirEmprestimo({id}).then((response)=>{
