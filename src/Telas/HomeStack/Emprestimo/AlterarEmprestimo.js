...
import { alterarEmprestimo, buscarEmprestimo } from "../../../utils/Emprestimo/emprestimoController";
import { ModalAlterarEmprestimo, ModalAlterarEntity } from "../../../Components/Modais";
import RetrieveDataById from "../../../Components/RetrieveDataById";


export function AlterarEmprestimo({route}) {
    ...
    if(modalVisible){
      return (
       ...
       id={id}
       labelID="Emprestimo: ID"
       labelActionBtn="Alterar Emprestimo"
       action={() => {alterarEmprestimo({id, idLivro, idEmprestimo}).then((response)=>{
      ...
      else
      {
        return (
          ...
          searchAction={() => {
            ...
            buscarEmprestimo({id}).then((response)=>{
