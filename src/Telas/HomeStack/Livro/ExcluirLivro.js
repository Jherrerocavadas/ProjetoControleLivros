...
import { buscarLivro, excluirLivro } from "../../../utils/Livro/livroController";
import { ModalLivro } from "../../../Components/Modais";


export function ExcluirLivro({route}) {
    ...
    if(modalVisible){
      return (
        ...
        nome={nome}
        telefone={telefone}
        labelActionBtn="Excluir Livro"
        action={() => {excluirLivro({id}).then((response)=>{
